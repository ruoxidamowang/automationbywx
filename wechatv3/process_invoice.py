...
class InvoiceProcessor:
    ...
    def start(self, msg_queue: queue.Queue, keep_remote: threading.Event, global_pause: threading.Event):
        starting = False
        """启动自动处理任务"""
        while True:
            global_pause.wait()
    ...
    def keep_remote_alive(self, keep_remote: threading.Event, global_pause: threading.Event):
        def do_keep():
